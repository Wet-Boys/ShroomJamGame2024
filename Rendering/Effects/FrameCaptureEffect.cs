...
[Tool]
[GlobalClass]
public partial class FrameCaptureEffect : BaseCompositorEffect
{
    public static readonly StringName Context = "FrameCaptureEffect";
    public static readonly StringName SceneColorName = "scene_color";

    public static bool CaptureNextFrame;
    
    private static FrameCaptureEffect? _instance;

    public static FrameCaptureEffect Instance
    {
        get
        {
    ...
    public readonly RDAttachmentFormat SceneColorAttachmentFormat = new()
    {
        Format = RenderingDevice.DataFormat.R16G16B16A16Sfloat,
        Samples = RenderingDevice.TextureSamples.Samples1,
        UsageFlags = (uint)(RenderingDevice.TextureUsageBits.ColorAttachmentBit | RenderingDevice.TextureUsageBits.StorageBit | RenderingDevice.TextureUsageBits.SamplingBit)
    };
